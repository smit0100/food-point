    ...
    <div className="relative h-screen w-screen">
      ...
      <div className="absolute top-40 sm:left-[40px] md:left-[400px] space-y-3">
        <p className="text-4xl text-white ">
          Register your restaurant on FOODPOINT
        </p>
        ...
        {owner !== null && owner.isApproved === "Not Request" ? (
          <button
            className="text-xl bg-blue-500 font-light px-14 rounded py-2 text-white "
            onClick={() => navigate("/resturantRegister")}
          >
            ...
            <div className="w-full sm:w-1/2 pt-5 sm:pt-0">
              <ul className="space-y-4">
                <li className="flex gap-2">
                  {checkMark}Dish images for top 5 items
                </li>
